...
class Train(CMD):
    ...
    def __call__(self, args):
        ...
        total_time_eval = timedelta()
        total_time_train = timedelta()
        ...
        print(f"average time eval of each epoch is {total_time_eval / epoch}s")
        print(f"average time train of each epoch is {total_time_train / epoch}s")
